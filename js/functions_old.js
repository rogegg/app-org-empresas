...
var context_conceptos2 = new Object();
...
function leerConceptos(json) {
  ...
  context_conceptos2.variable = new Array();
...
/*PRUEBA
      context_conceptos2.variable[j] = {
              nombre_variable: json.feed.entry[i].gsx$variable.$t,
              subvariables: [
                {
                  nombre_subvariable: "subvariable",
                  conceptos: ["concepto", "concepto2","concepto3"]
                }
...
*/
  ...
  console.log(context_conceptos2.variable);
